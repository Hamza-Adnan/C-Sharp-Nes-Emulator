...
using NESDOTNET.Controllers;
using NESDOTNET.Mappers;
...
namespace NESDOTNET
{
    class EMU_MAIN
    {
        ...
        public readonly CPU_CLASS CPU;

        public readonly PPU PPU;

        public readonly BaseMapper Mapper;

        public readonly Cartridge_CONTROLLER Cartridge;

        private readonly string _path;

        public EMU_MAIN(string path, IController controller)
        {
            _path = path;
            Cartridge = new Cartridge_CONTROLLER(path);
