...
namespace NESDOTNET.Mappers
{
    ...
    class MMC1 : BaseMapper
    {
        ...
        private readonly Cartridge_CONTROLLER.VRAMMirroringMode[] _mirroringModes = { Lower, Upper, Vertical, Horizontal };
        ...
        public MMC1(EMU_MAIN emulator) : this(emulator, ChipType.MMC1B)
        {

        }

        public MMC1(EMU_MAIN emulator, ChipType chipType) : base(emulator)
        {
            _type = chipType;
